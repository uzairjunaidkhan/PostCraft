...
export default function LinkedInPostGenerator() {
  ...
  const startDraftEditing = (idx: number) => {
    setEditingDraft(idx);
    setEditedContent({ ...posts[idx] });
  };
                      ...
                      <article key={draft.id || idx} className="border rounded-xl p-4 space-y-3 bg-muted/30">
                        {editingDraft === idx ? (
                          <div className="space-y-3">
                            ...
                            {/* Save / Cancel buttons */}
                            <div className="flex gap-2">
                              <Button size="sm" variant="outline" onClick={saveDraftEdit}>
                                <Save className="h-4 w-4 mr-1" /> Save
                              </Button>
                              <Button size="sm" variant="outline" onClick={cancelDraftEdit}>
                                <X className="h-4 w-4 mr-1" /> Cancel
                              </Button>
                            </div>
                          </div>
                            ...
                            <div className="flex justify-between gap-2">
                              <div className="flex gap-1 shrink-0">
                                <TooltipProvider>
                                  <Tooltip>
                                    <TooltipTrigger asChild>
                                      <Button size="sm" variant="outline" onClick={() => startDraftEditing(idx)}>
                                        <Edit2 className="h-4 w-4" />
                                      </Button>
                                    </TooltipTrigger>
                                    <TooltipContent side="bottom">Edit post</TooltipContent>
